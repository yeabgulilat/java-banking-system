 ...
 * Fee display added to confirmation dialog.
 * All layout and styling unchanged from Phase 1.
 */
public class TransferPanel extends JPanel {
    ...
    private JPanel buildPageHeader() {
        ...
        JLabel sub = new JLabel(
                "Transfer funds to any Habesha Bank account or other banks"
        );
    ...
    private JPanel buildTransferForm() {
        ...
        recipientField =
                new HabeshaTextField("Account number or IBAN", 20);

        recipientField.setMaximumSize(
                new Dimension(Integer.MAX_VALUE, 40)
        );
        ...
        recipientNameField =
                new HabeshaTextField("e.g. Kaleb Girma", 20);

        recipientNameField.setMaximumSize(
                new Dimension(Integer.MAX_VALUE, 40)
        );
        ...
        amountField =
                new HabeshaTextField("e.g. 3000.00", 20);
    ...
    private void handleTransfer() {
        ...
        if (recipientField.getText().trim().isEmpty()) {
            showError("Recipient account is required.");
            return;
        }
