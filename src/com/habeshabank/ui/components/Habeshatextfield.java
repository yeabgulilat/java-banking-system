...
/**
 * Styled text field with gold focus ring and placeholder support.
 */
public class HabeshaTextField extends JTextField {

    private String placeholder;
    private boolean focused = false;

    public HabeshaTextField(String placeholder, int columns) {
        super(columns);
        this.placeholder = placeholder;
        applyStyle();
    }

    public HabeshaTextField(int columns) {
        super(columns);
        applyStyle();
    }
    ...
    private void applyStyle() {
        ...
        addFocusListener(new FocusAdapter() {
            @Override public void focusGained(FocusEvent e) { focused = true;  updateBorder(true);  repaint(); }
            @Override public void focusLost(FocusEvent e)   { focused = false; updateBorder(false); repaint(); }
        });
    }
